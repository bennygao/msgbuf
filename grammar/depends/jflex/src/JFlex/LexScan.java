...
public final class LexScan implements sym, java_cup.runtime.Scanner {
	 ...
	 */
	private static final int ZZ_LEXSTATE[] = { 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 6,
			6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14 };

	/**
	 * Translates characters to character classes
	 */
	private static final String ZZ_CMAP_PACKED = "\10\25\1\26\1\10\1\13\2\11\1\12\16\25\4\0\1\10\1\76"
	...
	private static final String ZZ_ACTION_PACKED_0 = "\1\1\1\2\15\0\1\1\2\3\1\1\1\2\3\4"
	...
	private static final String ZZ_TRANS_PACKED_0 = "\11\20\2\21\1\22\13\20\1\21\5\20\1\23\51\20"
	...
	private static final String ZZ_ATTRIBUTE_PACKED_0 = "\2\1\15\0\2\1\1\11\4\1\1\11\2\1\1\11"
			...
			+ "\1\0\2\1\1\0\1\1\3\0\1\1\2\0\1\1" + "\1\11\2\1\10\0\1\11\3\1";
	...
	private static final class ZzFlexStreamInfo {
		...
		ZzFlexStreamInfo(java.io.Reader zzReader, int zzEndRead,
				int zzStartRead, int zzCurrentPos, int zzMarkedPos,
	 ...
	 * Lexical state, line, char, and column counting remain untouched.
	 * 
	 * The current input stream can be restored with yypopstream (usually in an
	 * <<EOF>> action).
	 * 
	 * @param reader
	...
	public final void yypushStream(java.io.Reader reader) {
		zzStreams
				.push(new ZzFlexStreamInfo(zzReader, zzEndRead, zzStartRead,
						zzCurrentPos, zzMarkedPos, zzBuffer, zzAtEOF, yyline,
						yycolumn));
		zzAtEOF = false;
	...
	public Symbol next_token() throws java.io.IOException {
		...
		while (true) {
			...
			case 113: {
				...
				if (!f.canRead())
					throw new ScannerException(file,
							ErrorMessages.NOT_READABLE, yyline);
				// check for cycle
				if (files.search(f) > 0)
					throw new ScannerException(file, ErrorMessages.FILE_CYCLE,
							yyline);
				try {
			...
			case 39: {
				throw new ScannerException(file,
						ErrorMessages.EOL_IN_CHARCLASS, yyline, yycolumn);
			}
			case 172:
				break;
			case 5: {
			...
			case 181:
				break;
			case 109: {
				throw new ScannerException(file, ErrorMessages.QUIL_CUPSYM,
						yyline);
			}
			case 182:
				break;
			...
			case 87: {
				cupCompatible = true;
				isImplementing = concExc(isImplementing,
			...
			case 197:
				break;
			case 47: {
				throw new ScannerException(file, ErrorMessages.CTOR_ARG,
						yyline, yycolumn);
			}
			case 198:
				break;
			case 108: {
				throw new ScannerException(file, ErrorMessages.QUIL_THROW,
						yyline);
			}
			case 199:
				break;
			...
			case 37: {
				throw new ScannerException(file,
						ErrorMessages.UNTERMINATED_STR, yyline, yycolumn);
			}
			case 208:
				break;
			case 110: {
			...
			case 65: {
				yybegin(REPEATEXP);
				return symbol(REPEAT, new Integer(yytext().trim().substring(1)
						.trim()));
			}
			case 214:
				break;
			case 80: {
				return symbol(
						CHAR,
						new Character((char) Integer.parseInt(yytext()
								.substring(2, yytext().length()), 16)));
			}
			case 215:
				break;
			case 140: {
			...
			default:
				if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
					...
					case CHARCLASS: {
						throw new ScannerException(file,
								ErrorMessages.EOF_IN_REGEXP);
					}
					case 830:
						break;
					case JAVA_CODE: {
						throw new ScannerException(file,
								ErrorMessages.EOF_IN_ACTION, action_line - 1);
					}
					case 831:
						break;
					case REPEATEXP: {
					...
					case COMMENT: {
						throw new ScannerException(file,
								ErrorMessages.EOF_IN_COMMENT);
					}
					case 833:
						break;
					case STATES: {
						throw new ScannerException(file,
								ErrorMessages.EOF_IN_STATES);
					}
					case 834:
						break;
					case COPY: {
