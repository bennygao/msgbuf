#ifndef __BYACC_DEFINES_H__
#define __BYACC_DEFINES_H__
...
/* Functions for output Java source file */
#define MAX_DATA_NUM	5000
#define LINE_DATA_NUM	10

void output_java_init_code_header(void);
void output_java_init_code_tail(void);
void output_java_init_code(char*, char*, char*, int);
